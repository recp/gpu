foreach(required
        ...
        GPU_ANDROID_ABI
        GPU_ANDROID_DEX
        GPU_ANDROID_TRIANGLE_ASSET
        GPU_ANDROID_CUBE_ASSET
        GPU_ANDROID_TRIANGLE_PREVIEW
        GPU_ANDROID_CUBE_PREVIEW
...
file(COPY_FILE
  "${GPU_ANDROID_TRIANGLE_ASSET}"
  "${GPU_ANDROID_STAGE}/assets/triangle.us"
)
file(COPY_FILE
  "${GPU_ANDROID_CUBE_ASSET}"
  "${GPU_ANDROID_STAGE}/assets/textured_cube.us"
)
file(COPY_FILE
  "${GPU_ANDROID_TRIANGLE_PREVIEW}"
  "${GPU_ANDROID_STAGE}/assets/previews/triangle.png"
)
file(COPY_FILE
  "${GPU_ANDROID_CUBE_PREVIEW}"
  "${GPU_ANDROID_STAGE}/assets/previews/textured-cube.png"
)
