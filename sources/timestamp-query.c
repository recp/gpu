...
#define GPU_COMPUTE_UNSUPPORTED_STATUS "GPU: WebGPU timestamp queries unsupported by this adapter"
#define GPU_COMPUTE_READY_STATUS "GPU: WebGPU USL pass timestamp queries recording"
#define GPU_COMPUTE_TIMESTAMP_RESOLVED_STATUS "GPU: WebGPU USL compute and render timestamps resolved"
