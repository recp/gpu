...
#define GPU_COMPUTE_FALLBACK_READY_STATUS "GPU: WebGPU subgroup shuffle emulated with workgroup memory"
#define GPU_COMPUTE_UNSUPPORTED_STATUS "GPU: WebGPU subgroups unsupported by this adapter"
#define GPU_COMPUTE_READY_STATUS "GPU: WebGPU USL subgroup shuffle ready"
