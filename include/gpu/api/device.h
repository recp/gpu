...
typedef struct GPUApiDevice {
  ...
  GPUPhysicalDevice* (*getAvailablePhysicalDevicesBy)(struct GPUApi *, GPUInstance * __restrict inst, uint32_t maxNumberOfItems);
  GPUDevice* (*createDevice)(GPUPhysicalDevice *phyDevice);
} GPUApiDevice;
