...
static const GPUCudaFormatInfo cuda_formats[GPU_FORMAT_COUNT] = {
  ...
  [GPU_FORMAT_DEPTH16_UNORM] =
    CUDA_FORMAT(CU_AD_FORMAT_UNSIGNED_INT16, CUDA_SAMPLED_FLAGS, 2u, 1u),
  [GPU_FORMAT_DEPTH32_FLOAT] =
    CUDA_FORMAT(CU_AD_FORMAT_FLOAT, CUDA_SAMPLED_FLAGS, 4u, 1u)
};
