...
GPU_ASSERT_64BIT_SIZE(GPUSharedBufferBarrierEXT, 40u);
GPU_ASSERT_64BIT_SIZE(GPUSharedTextureBarrierEXT, 40u);
GPU_ASSERT_64BIT_SIZE(GPUSharedBarrierBatchEXT, 32u);
