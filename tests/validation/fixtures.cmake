...
if(GPU_BUILD_DX12 AND (GPU_BUILD_TESTS OR GPU_BUILD_SAMPLES))
  ...
  gpu_add_usl_fixtures(
    GPU_DX12_F64_MATH_FIXTURE
    dxil
    validation
    "${PROJECT_SOURCE_DIR}/tests/validation/f64-math-dx12-usl/f64_math.usl"
  )
  list(GET GPU_DX12_F64_MATH_FIXTURE 0 GPU_DX12_F64_MATH_US)
  list(APPEND GPU_DX12_USL_FIXTURES ${GPU_DX12_F64_MATH_FIXTURE})
  gpu_add_usl_fixtures(
    GPU_DX12_F64_MATH_HLSL_FIXTURE
    dx12
    validation
    "${PROJECT_SOURCE_DIR}/tests/validation/f64-math-dx12-usl/f64_math.usl"
  )
  list(GET GPU_DX12_F64_MATH_HLSL_FIXTURE 0 GPU_DX12_F64_MATH_HLSL_US)
  list(APPEND GPU_DX12_USL_FIXTURES ${GPU_DX12_F64_MATH_HLSL_FIXTURE})
  gpu_add_usl_fixtures(
    GPU_DX12_F64_EXPONENTIAL_FIXTURE
    dx12
    validation
    "${PROJECT_SOURCE_DIR}/tests/validation/f64-exponential-dx12-usl/f64_exponential.usl"
  )
  list(GET GPU_DX12_F64_EXPONENTIAL_FIXTURE 0
...
if(GPU_BUILD_VULKAN AND (GPU_BUILD_TESTS OR GPU_BUILD_SAMPLES))
  ...
  gpu_add_usl_fixtures(
    GPU_VULKAN_F16_BUILTINS_FIXTURE
    vulkan
    validation
    "${PROJECT_SOURCE_DIR}/tests/validation/f16-builtins-usl/f16_builtins.usl"
  )
  unset(GPU_USL_FIXTURE_TARGET_CAPS)
  list(GET GPU_VULKAN_F16_BUILTINS_FIXTURE 0 GPU_VULKAN_F16_BUILTINS_US)
  list(APPEND GPU_VULKAN_USL_FIXTURES ${GPU_VULKAN_F16_BUILTINS_FIXTURE})
  add_custom_target(gpu-vulkan-f16-builtins-fixture
    DEPENDS ${GPU_VULKAN_F16_BUILTINS_FIXTURE}
  )
  if(GPU_BUILD_TESTS)
    gpu_add_usl_fixtures(
